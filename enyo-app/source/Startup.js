	...
	components: [
		...
		{layoutKind: "VFlexLayout", flex: 1, align: "left", style: "padding-right: 10px; font-size: 14px;", components: [
			{name: "changelogScroller", kind: "Scroller", height: "613px", components: [
				...
				{kind: "Divider", caption: "3.0.3"},
				{content: "<ul><li>Cleaned up version for LuneOS without Mojo</li></ul>"},

     			{kind: "Divider", caption: "3.0.2"},
				{content: "<ul><li>Initial version for LuneOS</li></ul>"},
